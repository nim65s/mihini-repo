...
- the *_standalone_pkg.tar is the file to be hosted for update using AWT-DA Software Update Command
- the *_standalone_pkg.tar.md5 contains the md5 to provide as second param of AWT-DA Software Update Command
