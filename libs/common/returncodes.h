...
typedef enum
{
  ...
  RC_WOULD_BLOCK         =   -8,  ///< Would have blocked if non-blocking behaviour was not requested.
  ...
  RC_IO_ERROR            =  -14,  ///< An IO error occured.
  RC_NOT_IMPLEMENTED     =  -15,  ///< This feature is not implemented.
  RC_BUSY                =  -16,  ///< The compoenent or service is busy.
